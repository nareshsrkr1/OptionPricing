...
def download_model():
    ...
    try:
        ...
        ##commenting below as these are set with azure blob storage downloads
        ...
        ##Commenting for Azure blob upload ens here
        configuration = get_all_configurations()
        download_directory = configuration['files']['model_filename']
        download_file = configuration['files']['scaler_filename']
...
if __name__ == '__main__':
    ...
    download_thread = Thread(target=download_model)
